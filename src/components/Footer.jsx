        ...
        <div className={styles.grid}>
          <div className={styles.info}>
            <div className={styles.logo}>
              <img src="/images/logo.jpeg" alt="Khushyog Logo" className={styles.logoImage} />
              <h3>Khushyog</h3>
            </div>
            <p>Yoga, Meditation & Healing for a Balanced Life</p>
            <div className={styles.socialLinks}>
              <a href="https://www.instagram.com/khushyali.manifest?igsh=MWwyaXpsMmw0NW92bQ==" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
          ...
          <div className={styles.contact}>
            ...
            <p>
              <span className={styles.contactIcon}>📞</span>
              <a href="tel:+917758048373">+91 7758-048373</a>
            </p>
            <p>
              <span className={styles.contactIcon}>📧</span>
